...
TELEGRAM_BOT_TOKEN = "8624909136:AAFc5ahlgqlYTDsEzUn3GRkNLEa3f5C0VtQ"
...
COUNTRY_DATA = {
    ...
    "234": {"n": "نيجيريا", "f": "🇳🇬"},
    "235": {"n": "تشاد", "f": "🇹🇩"},
    "236": {"n": "جمهورية أفريقيا الوسطى", "f": "🇨🇫"},
    "237": {"n": "الكاميرون", "f": "🇨🇲"},
    "238": {"n": "الرأس الأخضر", "f": "🇨🇻"},
    "239": {"n": "ساو تومي وبرينسيب", "f": "🇸🇹"},
    "240": {"n": "غينيا الاستوائية", "f": "🇬🇶"},
    "241": {"n": "الغابون", "f": "🇬🇦"},
    "242": {"n": "الكونغو", "f": "🇨🇬"},
    "243": {"n": "الكونغو الديمقراطية", "f": "🇨🇩"},
    "244": {"n": "أنغولا", "f": "🇦🇴"},
    "245": {"n": "غينيا بيساو", "f": "🇬🇼"},
    "246": {"n": "دييغو غارسيا", "f": "🇮🇴"},
    "247": {"n": "جزيرة أسينشيون", "f": "🇦🇨"},
    "248": {"n": "سيشل", "f": "🇸🇨"},
    "249": {"n": "السودان", "f": "🇸🇩"},
    "250": {"n": "رواندا", "f": "🇷🇼"},
    "251": {"n": "إثيوبيا", "f": "🇪🇹"},
    ...
    "597": {"n": "سورينام", "f": "🇸🇷"},
    "598": {"n": "أوروغواي", "f": "🇺🇾"},
    "599": {"n": "جزر الكاريبي الهولندية", "f": "🇧🇶"},
    "670": {"n": "تيمور الشرقية", "f": "🇹🇱"},
    "672": {"n": "القارة القطبية الجنوبية", "f": "🇦🇶"},
    "673": {"n": "بروناي", "f": "🇧🇳"},
    "674": {"n": "ناورو", "f": "🇳🇷"},
